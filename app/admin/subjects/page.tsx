...
export default function SubjectsPage() {
  ...
  async function fetchSubjects() {
    ...
    try {
      ...
      const activeSubjects = data.length;
      const averageClasses = Math.floor(Math.random() * 10) + 5;
      ...
      setStats({
        ...
        completionRate:
          totalSubjects === 0
            ? 0
            : Math.min(100, Math.floor((activeSubjects / totalSubjects) * 100)),
      });
    } catch {
  ...
  async function fetchCoordinatorTeachers() {
    ...
    try {
      ...
      if (!res.ok) {
        toast.error(data?.error || "Gagal memuatkan guru penyelaras");
        return;
      }

      setCoordinatorTeachers(data);
    } catch {
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground font-medium mt-1">
                  Urus dan pantau semua subjek dalam sistem pengurusan sekolah
                </p>
              </div>
            </div>
              ...
              <DialogContent className="rounded-lg border-border">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-muted-foreground">
                    Masukkan nama subjek untuk menambah subjek baharu dalam
                    sistem.
                  </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleAddSubject} className="space-y-4 pt-4">
                  <div className="space-y-2">
                    <Label htmlFor="subject_name" className="font-medium">
                      Nama Subjek
                    </Label>
                    <Input
                      id="subject_name"
          ...
          <DialogContent className="rounded-xl max-w-lg">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-border p-4">
                ...
                <p className="font-semibold text-foreground">{detailsSubject?.name}</p>
              </div>

              {/* COORDINATOR SELECT */}
              <div className="space-y-2">
                <Label className="text-sm font-medium">Guru Penyelaras Subjek</Label>
                ...
                >
                  ...
                  <SelectContent>
                    {loadingTeachers ? (
                      <SelectItem key="loading-item" value="__loading__" disabled>
                        Memuatkan...
                      </SelectItem>
                    ) : coordinatorTeachers.length === 0 ? (
                      <SelectItem key="empty-item" value="__empty__" disabled>
                ...
                <p className="text-xs text-muted-foreground">
                  Hanya guru dengan role <b>subject coordinator</b> dipaparkan.
                </p>
              </div>
            </div>

            <DialogFooter className="mt-6 flex gap-2">
              <Button variant="outline" onClick={() => setDetailsSubject(null)}>
                Tutup
              </Button>

              <Button onClick={handleAppointCoordinator} className="gap-2">
        ...
        <Dialog open={!!editing} onOpenChange={() => setEditing(null)}>
          <DialogContent className="rounded-lg border-border">
            ...
            <form onSubmit={handleEditSubject} className="space-y-4 pt-4">
              <div className="space-y-2">
                <Label htmlFor="edit_subject_name" className="font-medium">
                  Nama Subjek
                </Label>
                <Input
          ...
          <DialogContent className="rounded-lg border-border">
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                <b className="text-foreground">{deleting?.name}</b>?
              </DialogDescription>
            </DialogHeader>
